...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  mysqli_stmt_bind_param($stmt, "sssssssss", $nama, $alamat, $telpon, $email, $web, $pendidikan, $pengalaman_kerja, $keterampilan, $foto_path);
  ...
  <!-- <div class="container mt-5"> -->
    <nav class="navbar sticky-top bg-body-tertiary biru">
      <div class="container-fluid">
        <h1>Update CV</h1>
        <a class="navbar-brand" href="/MYCV">View</a>
      </div>
    </nav>
    <div class="card">
      <div class="p-3">
        <div class="card-body">
          <form method="post">
            <div class="mb-3">
              ...
              <input class="form-control" id="telpon" type="text" name="telpon" value="<?php echo $data['telpon']; ?>" placeholder="Telpon" required>
